...
/**
 * Base class for the Finance service.
 */
class FinanceBaseService extends \DTS\eBaySDK\Services\BaseRestService
{
    /**
     * @var array $endPoints The API endpoints.
     */
    protected static $endPoints = [
        'sandbox'    => 'https://api.sandbox.ebay.com/sell/finances',
        'production' => 'https://apiz.ebay.com/sell/finances'
    ];
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DTS\eBaySDK\Finance\Services\FinanceService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
