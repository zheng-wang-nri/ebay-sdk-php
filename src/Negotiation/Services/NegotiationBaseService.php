 ...
 */
class NegotiationBaseService extends \DTS\eBaySDK\Services\BaseRestService
{
    /**
     * @var array $endPoints The API endpoints.
     */
    protected static $endPoints = [
        'sandbox'    => 'https://api.sandbox.ebay.com/sell/negotiation',
        'production' => 'https://api.ebay.com/sell/negotiation'
    ];
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DTS\eBaySDK\Negotiation\Services\NegotiationService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
